...
class Currency:
    def __init__(self, decimals: int, contract: str, return_price: int | None) -> None:
...
class Currencies:
    currencies = {
        "Polygon": {
            "POL": Currency(
                decimals=10**18, contract=None, return_price=return_asset_price
            ),
            "USDT": Currency(
                decimals=10**6, contract=contracts["usdt_pol"], return_price=None
            ),
            "USDC": Currency(
                decimals=10**6, contract=contracts["usdc_pol"], return_price=None
            ),
        },
        "Optimism": {
            "ETH": Currency(
            ...
            "USDT": Currency(
                decimals=10**6, contract=contracts["usdt_op"], return_price=None
            ),
            "USDC": Currency(
                decimals=10**6, contract=contracts["usdc_op"], return_price=None
            ),
        },
        "Arbitrum": {
            "ETH": Currency(
            ...
            "USDT": Currency(
                decimals=10**6, contract=contracts["usdt_arb"], return_price=None
            ),
            "USDC": Currency(
                decimals=10**6, contract=contracts["usdc_arb"], return_price=None
            ),
        },
        "Base": {
            "ETH": Currency(
            ...
            "USDC": Currency(
                decimals=10**6, contract=contracts["usdc_base"], return_price=None
            ),
            "DAI": Currency(
                decimals=10**18, contract=contracts["dai_base"], return_price=None
            ),
        },
    }
